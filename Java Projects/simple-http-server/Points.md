[Creating a HTTP Server in Java. Java has a massive ecosystem of HTTP… | by Robert Finn | Medium](https://rjlfinn.medium.com/creating-a-http-server-in-java-9b6af7f9b3cd)
